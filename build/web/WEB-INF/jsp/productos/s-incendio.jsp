	...
	<div class="container Contenido">
		<div class="row">
			<div class="col-md-8 col-sm-12 mb-3">
				<div class="row">
					<div class="col-12">
						<h4 class="text-center">Sistema Contra Incendio</h4>
					</div>				

    				<div class="col-lg-6 col-md-6 mb-lg-0 my-4">							   
				      <div class="card align-items-center">		   
				        <div class="view overlay">
				          <img src="<c:url value="/resources/images/producto-13.jpg"/>" class="card-img-top" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				        <div class="card-body text-center">						          
				            <h5 class="grey-text">Kit Basico Contra Incendios MIRCOM</h5>
				          <h5 class="dark-grey-text">
				            <span class="badge badge-pill danger-color">NEW</span>
				          </h5>
				          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ProductosBasicos">Más Información</button>       				          
				        </div>
				      </div>	
    				</div>
    				...
    				<div class="col-lg-6 col-md-6 mb-lg-0 my-4">							   
				      <div class="card align-items-center">		   
				        <div class="view overlay">
				          <img src="<c:url value="/resources/images/producto-14.jpg"/>" class="card-img-top" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				        <div class="card-body text-center">						          
				            <h5 class="grey-text">Productos Individuales Contra Incendios
				            MIRCOM</h5>
				          <h5 class="dark-grey-text">
				            <span class="badge badge-pill danger-color">NEW</span>
				          </h5>
				          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ProductosIndividuales">Más Información</button>       				          
				        </div>
				      </div>	
    				</div>
    				...
    				<div class="col-lg-6 col-md-6 mb-lg-0 my-4">							   
				      <div class="card align-items-center">		   
				        <div class="view overlay">
				          <img src="<c:url value="/resources/images/producto-15.jpg"/>" class="card-img-top" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				        <div class="card-body text-center">						          
				            <h5 class="grey-text">Kit Completo Contra Incendios MIRCOM</h5>
				          <h5 class="dark-grey-text">
				            <span class="badge badge-pill danger-color">NEW</span>
				          </h5>				          
				          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ProductosCompletos">Más Información</button>       				          
				        </div>
				      </div>	
    				</div>    			 		
			...
			<div class="col-md-4 col-sm-12">
					<h2 class="tituloX">Contácto</h2>
					  ...
					  <div class="form-check">
                        ...
                        <div class="modal fade right" id="ProductosIndividuales" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">          
                <div class="modal-content">         
                <div class="modal-header">
                    <p class="heading lead">Productos Individuales Mircom</p>                    
                </div>              
                <div class="modal-body">
                    <div class="text-center">                                
                        <p>Entendemos tus exigencías por eso, RAYTECD NETWORKS te brinda entre las mejores opciones, la compra de nuestros productos por unidad, y hacemos la instalación de las mismas.                        
                    	</p>
                    	<p>Todos nuestros sistemas están diseñado para la protección contra incendios y de comunicaciónes durante emergencias.</p>
                    	<p>Descuide, somos expertos en nuestra materia, clientes nuestros nos avalan.</p>
                        <img src="<c:url value="/resources/images/producto-14.jpg"/>" class="img-fluid ">    
                    </div>                    	
                </div>           
        ...
        <div class="modal fade right" id="ProductosCompletos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">          
                <div class="modal-content">         
                <div class="modal-header">
                    <p class="heading lead">Kit Completo Contra Incendios Mircom</p>                    
                </div>              
                <div class="modal-body">
                    <div class="text-center">                                
                        <p>En RAYTECD NETWORKS nos preocupamos por su seguridad y la de su familia, empresa y/o negocio.                        
                    	</p>
                    	<p>Por eso RAYTECD NETWORKS brinda una protección completa y segura contra incendios, protegiendo la calidad de vida y de sus pertenencias.</p>
                    	<p>Todos nuestros sistemas están diseñado para la protección contra incendios y de comunicaciónes durante emergencias.</p>
                    	
                         <img src="<c:url value="/resources/images/producto-15.jpg"/>" class="img-fluid ">   
                    </div>
        ...
        <div class="modal fade right" id="ProductosBasicos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">          
                <div class="modal-content">         
                <div class="modal-header">
                    <p class="heading lead">Kit Básico Contra Incendios Mircom</p>                    
                </div>              
                <div class="modal-body">
                    <div class="text-center">                                
                        <p>En RAYTECD NETWORKS nos preocupamos por su seguridad y la de su familia y/o negocio.                        
                    	</p>
                    	<p>Por eso RAYTECD NETWORKS brinda una protección al alcance de su bolsillo, protegiendo la calidad de vida de su familia.</p>
                    	<p>Todos nuestros sistemas están diseñado para la protección contra incendios y de comunicaciónes durante emergencias.</p>
                    	<img src="<c:url value="/resources/images/producto-13.jpg"/>" class="img-fluid ">
