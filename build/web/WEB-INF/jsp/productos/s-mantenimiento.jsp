	...
	<div class="container Contenido">
		<div class="row">
			<div class="col-md-8 col-sm-12 mb-3">
				<div class="row">
					<div class="col-12">
						<h4 class="text-center">Mantenimiento de Equipos Industriales</h4>
					</div>
				

    				<div class="col-lg-6 col-md-6 mb-lg-0 my-4">							   
				      <div class="card align-items-center text-white deep-orange darken-3">		   
				        <div class="view overlay mt-3">
				          <img src="<c:url value="/resources/images/producto-10.jpg"/>" class="card-img-top img-fluid z-depth-1 rounded-circle" alt="">
				          <a>
				        ...
				        <h4 class="card-title">MANTENIMIENTO PREVENTIVO</h4>         
				          <h5 >
				           Evite oportunamente fallas que influyan en el funcionamiento óptimo de sus equipos reduciendo coste de mantenimiento.                   
				          </h5>					                 				          
				        </div>
				      </div>	
    				</div> 
    				...
    				<div class="col-lg-6 col-md-6 mb-lg-0 my-4">							   
				      <div class="card align-items-center text-white cyan darken-3">		   
				        <div class="view overlay mt-3">
				          <img src="<c:url value="/resources/images/producto-11.jpg"/>" class="card-img-top img-fluid z-depth-1 rounded-circle" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				        ...
				        <h4 class="card-title">MANTENIMIENTO CORRECTIVO</h4>                     
				          <h5 >
				           Corregimos y reparamos los defectos observados de los equipos industriales optimizando el funcionamiento de lo mismo.                   
				          </h5>					                 				          
				        </div>
				      </div>	
    				</div> 

    				<div class="col-lg-12 col-md-6 mb-lg-0 my-4 ">							   
				      <div class="card align-items-center text-white green darken-3">		   
				        <div class="view overlay mt-3">
				          <img src="<c:url value="/resources/images/producto-12.jpg"/>" class="card-img-top img-fluid z-depth-1 rounded-circle" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				        <div class="card-body text-center">
				        <h4 class="card-title">PLANES ANUALES CORPORATIVOS</h4>				            
				          <h5 >
				           Contamos con planes diseñados de acuerdo a las necesidades de su empresa, los cuales le garantizan un servicio eficaz e inmediato durante todo el año.                   
				          </h5>					                 				          
				        </div>
				      </div>	
    				</div> 		
