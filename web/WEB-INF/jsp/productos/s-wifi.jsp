	...
	<div class="container Contenido">
		<div class="row">
			<div class="col-md-8 col-sm-12 mb-3">
				<div class="row">
					<div class="col-12">
						<h4 class="text-center">Hostpot Wifi-Publicidad</h4>
					</div>
					<div class="col-lg-6 col-md-6 mb-lg-0 my-4">						   
				      <div class="card align-items-center">		   
				        <div class="view overlay">
				          <img src="<c:url value="/resources/images/producto-1.png"/>" class="card-img-top" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				    <div class="card-body text-center">						          
				            <h5 class="grey-text">HotSpot 300 Intelbras</h5>
				          <h5 class="dark-grey-text">
				            <strong>Router de Wireless corporativo para pequeñas y medianas empresas.<span class="badge badge-pill danger-color">NEW</span> 				            
				            </strong>
				          </h5>
				          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Wifi">Más Información</button>       				          
				        </div>
				      </div>	
    				</div>
        ...
        <div class="modal fade right" id="Wifi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">          
                <div class="modal-content">         
                <div class="modal-header">
                    <p class="heading lead">HotSpot 300 Intelbras</p>                    
                </div>              
                <div class="modal-body">
                    <div class="text-center">                                               
                        <p>¿Alguna vez llegó a un establecimiento y pidió la contraseña del Wifi?
                        Si es así, sabe lo normal que es eso. 
                        </p>
                        <p>En cambio con el HotSpot 300 tendrá Wifi liberado para sus clientes, con la condición que den check-in y like en la página su establecimiento en Facebook</p>
                        <img src="<c:url value="/resources/images/wifix.png"/>" class="img-fluid offset-2">
