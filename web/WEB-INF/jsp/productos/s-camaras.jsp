	...
	<div class="container Contenido">
		<div class="row">
			<div class="col-md-8 col-sm-12 mb-3">
				<div class="row">
					<div class="col-12">
						<h4 class="text-center">Cámaras de Vigilancia</h4>
					</div>
					<div class="col-lg-6 col-md-6 mb-lg-0 my-4">							   
				      <div class="card align-items-center">		   
				        <div class="view overlay">
				          <img src="<c:url value="/resources/images/producto-2.png"/>" class="card-img-top" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>
                                        <div class="card-body text-center">						          
				            <h5 class="grey-text">4K 30x IR PTZ Cámara de Red Dahua</h5>
				          <h5 class="dark-grey-text">
				            <strong>Las Cámaras PTZ utilizan las funciones de giro, inclinación y zoom para proporcionar cobertura.<span class="badge badge-pill danger-color">NEW</span> 				            
				            </strong>
				          </h5>
    				...
    				<div class="col-lg-6 col-md-6 mb-lg-0 my-4">					   
				      <div class="card align-items-center">		   
				        <div class="view overlay">
				          <img src="<c:url value="/resources/images/producto-4.png"/>" class="card-img-top" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				        <div class="card-body text-center">						          
				            <h5 class="grey-text">4K Cámara tubular Dahua 1200 S3</h5>
				          <h5 class="dark-grey-text">
				            <strong>Las Cámaras Tubolares cuentan con Tecnología innovadora que mejora visiblemente la velocidad y el rendimiento a la hora de proteger su hogar.<span class="badge badge-pill danger-color">NEW</span> 				            
				            </strong>
				          </h5>
    				...
    				<div class="col-lg-6 col-md-6 mb-lg-0 my-4">						   
				      <div class="card align-items-center">		   
				        <div class="view overlay">
				          <img src="<c:url value="/resources/images/producto-5.jpg"/>" class="card-img-top" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				        <div class="card-body text-center">						          
				            <h5 class="grey-text">Cámara Domo Dahua 1080px</h5>
				          <h5 class="dark-grey-text">
				            <strong>Las Cámaras tipo Domo está calificado para trabajar de día y noche, con un gran tecnología que permite un gran rendimiento.<span class="badge badge-pill danger-color">NEW</span> 				            
				            </strong>
				          </h5>
    				...
    				<div class="col-lg-6 col-md-6 mb-lg-0 my-4">						   
				      <div class="card align-items-center">		   
				        <div class="view overlay">
				          <img src="<c:url value="/resources/images/producto-6.jpg"/>" class="card-img-top" alt="">
				          <a>
				            <div class="mask rgba-white-slight"></div>
				          </a>
				        </div>		
				        <div class="card-body text-center">						          
				            <h5 class="grey-text">720P HD Cámara tubular Dahua 1020 S3</h5>
				          <h5 class="dark-grey-text">
				            <strong>Cámara tipo tubular cuenta con una Iris de tipo fija y un sensor de tipo CMOS que permite un gran rendimiento.<span class="badge badge-pill danger-color">NEW</span> 				            
				            </strong>
				          </h5>
        ...
        <div class="modal fade right" id="Producto1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">          
                ...
                <div class="modal-header">
                    <p class="heading lead">4K 30x IR PTZ Cámara de Red Dahua</p>                    
                </div>              
                <div class="modal-body">
                    <div class="text-center">                                               
                        <p>Con un potente zoom óptico y vista panorámica. El rendimiento de esta cámara proporciona una solución todo en uno para capturar videovigilancia de larga distancia para aplicaciones al aire libre. Juntos con iluminación infrarroja, la cámara es la solución perfecta para la oscuridad. La serie combina un corte IR mecánico de día / noche
                            filtro para la más alta calidad de imagen en condiciones de iluminación variables durante el dia. 
                        </p>                        
                        <img src="<c:url value="/resources/images/info-1.PNG"/>" class="img-fluid offset-1">
        ...
        <div class="modal fade right" id="Producto2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">          
                <div class="modal-content">         
                <div class="modal-header">
                    <p class="heading lead">4K Cámara tubular Dahua 1200 S3</p>                    
                </div>
                    
                <div class="modal-body">
                    
                    <div class="text-center">
                        <p>Las Cámaras Tubolares cuentan con Tecnología innovadora que mejora visiblemente la velocidad y el rendimiento a la hora de proteger su hogar.</p>
                        <img src="<c:url value="/resources/images/producto-4.png"/>" class="img-fluid offset-1">
                    </div>
                    <table class="table table-striped ">    
                            ...
                            <tbody>
                                ...
                                <tr>                                   
                                    <td>Modelo: HAC-HFW1200R-S3</td>                                    
                                </tr>
                                <tr class="table-info">
                                    <td>Estructura: Metálica</td>                                    
                                </tr>
                                <tr>
                                    <td>Formatos: HDCVI/TVI/AHD/CVBS</td>                                   
                                </tr>
                                <tr class="table-info">
                                    <td>Resolución: FULL-HD (1080p/2Mp)</td>                                  
                                </tr>
                                <tr>
                                    <td>Alcance IR: 20 metros</td>                                
                                </tr>
                                <tr class="table-info">
                                    <td>Lente: 3.6mm</td>                                
                                </tr>
                                <tr>
                                    <td>Infrarrojo: Visión nocturna (B/N)</td>                                  
                                </tr>
                                <tr class="table-info">
                                    <td>Alimentación: 12V 1A</td>                                
                                </tr>                              
                            </tbody>                         
                        </table>              
        ...
        <div class="modal fade right" id="Producto3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">          
                <div class="modal-content">         
                <div class="modal-header">
                    <p class="heading lead">Cámara Domo Dahua 1080px</p>                    
                </div>              
                <div class="modal-body">
                    <div class="text-center">                                               
                        <p>Nuevo formato de construcción metálica con resistencia a la intemperie IP 67. Esta cámara de seguridad HDCVI provee una resolución de captura en formato Full HD 1920x1080 píxeles, en tiempo real, sin latencia visible. Se conecta de manera idéntica a una cámara de seguridad análoga standard y su formato tipo domo de color blanco, se confunde fácilmente con el techo, permitiendo un monitoreo con mínima presencia. 
                        </p>                        
                        <img src="<c:url value="/resources/images/producto-5.jpg"/>" class="img-fluid offset-1">
        ...
        <div class="modal fade right" id="Producto4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">          
                <div class="modal-content">         
                <div class="modal-header">
                    <p class="heading lead">720P HD Cámara tubular Dahua 1020 S3</p>                    
                </div>              
                <div class="modal-body">
                    <div class="text-center">                                               
                        <p>Dispone de una Óptica fija de 3.6 mm, con un campo de visión horizontal de 80º. 
                            LEDs infrarrojos que se activan automáticamente proporcionando así una imagen nítida a 0 Lux (oscuridad total) a una distancia máxima de 20 metros. 
                        </p>
                        <p>Dispone de filtro IR CUT automático que permite obtener durante el día una imagen con colores nítidos y reales.</p>
                        <img src="<c:url value="/resources/images/producto-6.jpg"/>" class="img-fluid offset-2">
